...
%
% Evaders behave following: Exponential Model
% --------------------------------------------------------------------------------
...
x_d = [-0.05 -0.25 0.00 0.15 0.45 -0.25]';

% Define initial position of the evaders 
x      = [-0.4 -0.4 0.0 0.0 0.5 0.1]';
x_plot = x;
x_prev = x;
...
theta_r   = 0.05*ones(M_evaders,1);
theta_e   = 0.04*ones(M_evaders,1);
